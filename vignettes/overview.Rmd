...
You can then use these multi-band rasters as basemaps for further plotting as 
desired.
...
combined_tiles <- mapply(function(x, y) {
  combine_overlays(x, y, output_file = tempfile(fileext = ".jpg"))
  },                            
  output_files[[2]],
  tile_overlays)
...
the [Unity vignette](https://mikemahoney218.github.io/terrainr/articles/unity_instructions.html).
