...
[National Map family of APIs](https://viewer.nationalmap.gov/services/), and 
...
Secondly, terrainr provides functions for manipulating these files, editing 
downloaded images to create new base map tiles:
...
```{r echo = FALSE}
knitr::include_graphics("man/figures/overlay.png")
```
...
```{r echo = FALSE}
knitr::include_graphics("man/figures/ggplot.png")
```
...
out. For more information, check out [the introductory vignette](https://mikemahoney218.github.io/terrainr/articles/overview.html) and 
[the guide to importing your data into Unity!](https://mikemahoney218.github.io/terrainr/articles/unity_instructions.html)
