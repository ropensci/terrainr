...
This feature branch requires the [unifir](https://github.com/mikemahoney218/unifir) package, currently not on CRAN.
If you want to try out the new features in this version -- particularly the new
`make_unity` function -- install unifir using the command:
...
Please note that unifir is currently very young and subject to change, and the
features in this branch are likely to change with it.
