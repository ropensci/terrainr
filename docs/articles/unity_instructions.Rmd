...
```{r echo=FALSE}
knitr::include_graphics("new_unity.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("new_scene.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("heightmap_import.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("tile_arrangement.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("create_layer.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("resize_layer.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("finished.png")
```

```{r echo=FALSE}
knitr::include_graphics("finished_again.png")
```
